...
<html lang="en">
    ...
    <link rel="canonical" href="https://narayanrahul.me" />
						...
						<li class="animate-box timeline-unverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">Goa Web Tech - Dec 2018 - Current</span>
								</div>
    ...
    <script>
        function sendMsg()
        {
            ...
            $.get("./send.php?value1="+fname+' '+lname+"&&value2="+email+' '+mobile+"&&value3="+message, function(data){
            });
            $('input').val('');
            $('textarea').val('');
